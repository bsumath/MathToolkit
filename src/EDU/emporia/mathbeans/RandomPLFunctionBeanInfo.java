...
{
	public RandomPLFunctionBeanInfo()
	{
	...
	*/
	...
	public java.awt.Image getIcon(int nIconKind)
	{
		...
		if (nIconKind == BeanInfo.ICON_COLOR_32x32)
			img = loadImage("PLFUNCTION32.gif");
	    else if (nIconKind == BeanInfo.ICON_MONO_32x32)
			img = loadImage("PLFUNCTION32.gif");
		else
			img = loadImage("/EDU/emporia/mathbeans/PLFUNCTION16.gif");
		
		return img;
	}

	private final Class beanClass = RandomPLFunction.class;
	//{{DECLARE_CONTROLS
	//}}
}